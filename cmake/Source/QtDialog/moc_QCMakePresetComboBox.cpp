...
void QCMakePresetComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QCMakePresetComboBox *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (QCMakePresetComboBox::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject QCMakePresetComboBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QComboBox::staticMetaObject>(),
    qt_meta_stringdata_QCMakePresetComboBox.data,
    qt_meta_data_QCMakePresetComboBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
