...
void QCMakePresetItemModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QCMakePresetItemModel *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QCMakePresetItemModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractItemModel::staticMetaObject>(),
    qt_meta_stringdata_QCMakePresetItemModel.data,
    qt_meta_data_QCMakePresetItemModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
